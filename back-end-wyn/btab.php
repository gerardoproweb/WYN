	...
	<div class="page-container">	
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
					<a href="<?php echo $variable ?>.php">Tabs 2</a>
				</li>
			</ol>
			<h2>Tabs 2 "Experiencia MAC&CO"</h2>
				...
				<div class="col-md-12">
					<div class="panel panel-primary" <?php if(!isset($_GET[$variable])) echo "data-collapsed='1'"; else echo"data-collapsed='0'" ?> >
						...
						<div class="panel-body">
							...
							<form enctype="multipart/form-data" action="php/procesa.php?a=btab" method="post" class="form-horizontal form-groups-bordered validate" id="form1" role="form">
					...
					$(document).on("click", ".eliminar", function () {
						...
						$(".modal-footer a").html("<a href='php/procesa.php?a=btab&b=1&id="+ eliminarId + "' class='btn btn-info'>Confirmar</a>");
					});
					</script>
					<script type="text/javascript">
					<?php if($_GET['a']==1){ ?>
