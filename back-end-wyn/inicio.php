...
$a=new DataBase();
$variable="inicio";
$detalles=$a->detalles("SELECT * FROM contenido WHERE seccion = 'testimonios'");
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body class="page-body">
	...
	<div class="page-container">	
		...
		<div class="main-content">
			...
			<h2><?php echo ucwords($variable) ?></h2>
			<br>
			...
			<div class="row">
				<div class="col-md-12">
                         ...
                         <div class="panel panel-primary" <?php if(!isset($_GET[$variable])) echo "data-collapsed='1'"; else echo"data-collapsed='0'" ?> >
                              ...
                              <div class="panel-heading">
                                   <div class="panel-options panel-title" style="float:left">
                                        Nuevo Elemento de <?php echo ucwords($variable) ?> <a href="#" data-rel="collapse"><i class="entypo-plus"></i></a>
                                   </div>                   
                              ...
                              <div class="panel-body">
                                   ...
                                   <form enctype="multipart/form-data" action="php/procesa.php?a=66" method="post" class="form-horizontal form-groups-bordered validate" id="form1" role="form">
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-sm-9">
                                                  <textarea style="width:100%" class="form-control wysihtml5" name="contenido" placeholder="Descripción" data-validate="required" data-message-required="Este campo es obligatorio."><?php if(isset($_GET[$variable]))echo $detalles[0]['contenido'] ?></textarea>
                                             </div>
                                        </div>
					...
					$(document).on("click", ".eliminar", function () {
						...
						$(".modal-footer a").html("<a href='php/procesa.php?a=6&b=1&id="+ eliminarId + "' class='btn btn-info'>Confirmar</a>");
					});
					</script>
					<script type="text/javascript">
					<?php if($_GET['a']==1){ ?>
