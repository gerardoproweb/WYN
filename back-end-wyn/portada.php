...
error_reporting(NULL);
 ...
 if(isset($_GET[$variable])){
 	$detalles=$a->detalles("SELECT * FROM slider WHERE idbanner = '".$_GET[$variable]."'");
 }
?>
<!DOCTYPE html>
<html lang="es">
	...
	<div class="page-container">	
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
					<a href="<?php echo $variable ?>.php">Portada</a>
				</li>
			</ol>
				...
				<div class="col-md-12">
					...
					<div class="panel panel-primary" <?php if(!isset($_GET[$variable])) echo "data-collapsed='1'"; else echo"data-collapsed='0'" ?> >
						...
						<div class="panel-body">
							...
							<form enctype="multipart/form-data" action="php/procesa.php?a=1" method="post" class="form-horizontal form-groups-bordered validate" id="form1" role="form">
										...
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
												<?php if(isset($_GET[$variable])){
													echo "<img src='../img/masterslider/".$detalles[0]["banner"]."' alt='...''>";
												}else{
													echo"<img src='http://placehold.it/300x225&text=1350x500'>";
												} 
												?>
											</div>
								...
								<div class="form-group">
									...
									<input type="hidden" name="portada2" value="<?php echo $detalles[0]["banner"] ?>">
					...
					$(document).on("click", ".eliminar", function () {
						...
						$(".modal-footer a").html("<a href='php/procesa.php?a=1&b=1&id="+ eliminarId + "' class='btn btn-info'>Confirmar</a>");
					});
					</script>
					<script type="text/javascript">
					<?php if($_GET['a']==1){ ?>
			...
			$(document).ready(function(){
				$("#menu-pages").sortable({
					update: function(event, ui) {
						$.post("php/procesa.php?a=11", { type: "orderPages", pages: $('#menu-pages').sortable('serialize') } );
					}
				});
			});
		</script>
