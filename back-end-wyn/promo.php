...
if(isset($_GET[$variable])){
	...
	$detalles=$a->detalles("SELECT * FROM contenido WHERE seccion = 'promo'");
}
?>
<!DOCTYPE html>
<html lang="es">
	...
	<div class="page-container">	
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
					<a href="<?php echo $variable ?>.php">Promocional</a>
				</li>
			</ol>
			<h2>Promocional</h2>
			...
			<div class="row">
			<form action="php/procesa.php?a=promo" method="post" enctype="multipart/form-data">
			...
			<div class="col-md-8">
				...
				<p></p>
				Línea 2
				<input type="text" class="form-control" name="contenido" data-validate="required" data-message-required="Este campo es obligatorio." placeholder="Titulo" value="<?php echo $detalles[0]["contenido"] ?>">
				<p>&nbsp;</p>
			...
			<div class="row">
				<div class="col-md-12">
					...
					$(document).on("click", ".eliminar", function () {
						...
						$(".modal-footer a").html("<a href='php/procesa.php?a=promo&b=1&id="+ eliminarId + "' class='btn btn-info'>Confirmar</a>");
					});
					</script>
					<script type="text/javascript">
					<?php if($_GET['a']==1){ ?>
