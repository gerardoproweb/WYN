...
if(isset($_GET[$variable])){
	...
	$detalles=$a->detalles("SELECT * FROM contenido WHERE idcontenido = '9'");
}
	...
	<div class="page-container">	
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">
				<li>
					<a href="#"><i class="entypo-home"></i>Servicios</a>
				</li>
				<li class="active">
					<a href="<?php echo $variable ?>.php">Portada Nosotros </a>
				</li>
			</ol>
			
			<div class="row">
				<div class="col-md-12">
					<h2>Portada Nosotros</h2>
			...
			<?php } ?>
					<div class="panel panel-primary" <?php if(!isset($_GET[$variable])) echo "data-collapsed='1'"; else echo"data-collapsed='0'" ?> >
						...
						<div class="panel-body">
							...
							<form enctype="multipart/form-data" action="php/procesa.php?a=3" method="post" class="form-horizontal form-groups-bordered validate" id="form1" role="form">
										...
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
												<?php if(isset($_GET[$variable])){
													echo "<img src='../img/nosotros/".$detalles[0]["portada"]."' alt='...''>";
												}else{
													echo"<img src='http://placehold.it/300x225&text=446x263'>";
												} 
												?>
											</div>
											...
											<div>
												...
												<p>La imagen tiene que ser de 446 x 263 px</p>
											</div>
										</div>
									</div>
								</div>
					...
					$(document).on("click", ".eliminar", function () {
						...
						$(".modal-footer a").html("<a href='php/procesa.php?a=3&b=1&id="+ eliminarId + "' class='btn btn-info'>Confirmar</a>");
					});
					</script>
					<script type="text/javascript">
					<?php if($_GET['a']==1){ ?>
